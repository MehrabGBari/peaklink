function [IntervalList,Jud_detect_good]=SILAC_Verification_intervaldetection_Spec_Pep(Pep,iso,XICs)
...
if ~isempty(Total_interval)
    for k=1:size(Total_interval,1)
        ...
        [intervalsdata01v2 ,Scan_start_afterfilter,Scan_end_afterfilter]=MS2intervalfilter_SILAC(intervaldata, MS2_Peak_Intensity01, intervalsdata01v1_afterfilter, MS2_Peak_Intensity01_afterfilter, Scan_start, Scan_end, Ms2_scannumber);
...
%         IntervalList.Labelling_effeciency(k)=Labelling_efficiency;
        ...
        if log_KL_Value_L<=-2.5 || log_KL_Value_H<=-2.5

function [Result,True]= Generate_Training_AWScores(TrainingInformation,PP_Parameter, flag,Parameters,Threshold)
...
%              LC_profile_B_CorrSum =Resampl(monoelutionprofile02);
 ...
 AccuracyATAW1step_Train=100*sum(True==1)/length(True)       

...
save ([Result_Save_Path,'\Midinformation'], 'IntervalList01', 'posi01', 'posi01v2', 'Maxquant_peptide_K_labeled',...
    'Maxquant_iso_K_labeled', 'Maxquant_peptide_HLR_K_labeled', 'Maxquant_peptide_cs_K_labeled', 'Maxquant_peptide_mass_K_labeled', 'Maxquant_peptide_ms2scannumber_K_labeled');


% i=20;
% MZ_axis=SALIC_totalmzList_K_labeled(i,:);
% Interval_SCAN=IntervalList01{i}.intervallist_after7_combine;
% SCAN_number=Interval_SCAN(2)-Interval_SCAN(1)+1;
% MZ_matrxi=ones(,1)
% Elution_matrix=zeros(,8);
% for j=1:8
%     Elution_matrix(:,j)=SILAC_XICs_Tolerance{j}(Interval_SCAN(1):Interval_SCAN(2),i);
% end
% figure
% plot3()
...
[Cal_HLRatio_new,Cal_ID_95]=Outlayer_cutting(Cal_HLRatio_notinf,3);
% figure
% subplot(2,1,1)
...
[Maxquant_HLR_K_Labeled_new,Maxquant_HLR_K_Labeled_new_ID_95]=Outlayer_cutting(Maxquant_HLR_K_Labeled,3);
% figure
% subplot(2,1,1)

function [score, nIntersect, nTesting, posFin, posErr] = alignResEvaErrRate(TrainingId_AB, TrainingId_AC, TestModel, Information_Matrix_Total, INTERVAL_Matrix)
...
for flag = 1:2;
    ...
    for scoreType =[2,1,4];
        [FinalResult, ~, ~, ~, ~, ~, pos, flagA] = pickAlignedPairs(TestModel_forTest, Information_Matrix_Total_forTest, scoreType);
        [FinalResult_forTest, pos_forTest,  posEtmp] = selFinalResult(FinalResult, pos, flagA, flag);
